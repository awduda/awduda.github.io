...
function create_thickness_point(n){
  ...
  $("#selected_image").click(function(e){
    $("#selected_image").append('<div id=t_'+n+' class="search-container" ><input id="search-box" type="text" class="search-box" name="q" /></div>');
...
$("#image_list_container").remove()
$("#selected_image_container").css("width","100%")
$("#selected_image_container").css("border","none")
$("#selected_image").css("left",($("#selected_image_container").width()-$("#selected_image").width())/2+"px")
